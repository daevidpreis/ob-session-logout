...
class MainWindow:
    def __init__(self, config_file):
        ...
        self.btnRestart = Gtk.Button.new_with_mnemonic(label="_Restart")
        ...
        self.btnShutdown = Gtk.Button.new_with_mnemonic(label="Shut_down")
        ...
        self.btnCancel = Gtk.Button.new_with_mnemonic(label="_Cancel")
